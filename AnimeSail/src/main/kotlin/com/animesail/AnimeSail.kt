...
class AnimeSail : MainAPI() {
    ...
    override val mainPage =
            mainPageOf(
                    "page/%d/" to "Episode Terbaru",
                    "movie-terbaru/page/%d/" to "Movie Terbaru",
                    "genres/donghua/page/%d/" to "Donghua",
                    "action/page/%d/" to "Action",
                    "adult-cast/page/%d/" to "Adult Cast",
                    "adventure/page/%d/" to "Adventure",
                    "award-winning/page/%d/" to "Award Winning",
                    "comedy/page/%d/" to "Comedy",
                    "demons/page/%d/" to "Demons",
                    "donghua/page/%d/" to "Donghua",
                    "drama/page/%d/" to "Drama",
                    "ecchi/page/%d/" to "Ecchi",
                    "fantasy/page/%d/" to "Fantasy",
                    "game/page/%d/" to "Game",
                    "harem/page/%d/" to "Harem",
                    "historical/page/%d/" to "Historical",
                    "horror/page/%d/" to "Horror",
                    "isekai/page/%d/" to "Isekai",
                    "kids/page/%d/" to "Kids",
                    "magic/page/%d/" to "Magic",
                    "martial-arts/page/%d/" to "Martial Arts",
                    "mecha/page/%d/" to "Mecha",
                    "military/page/%d/" to "Military",
                    "music/page/%d/" to "Music",
                    "mystery/page/%d/" to "Mystery",
                    "mythology/page/%d/" to "Mythology",
                    "parody/page/%d/" to "Parody",
                    "psychological/page/%d/" to "Psychological",
                    "reincarnation/page/%d/" to "Reincarnation",
                    "romance/page/%d/" to "Romance",
                    "school/page/%d/" to "School",
                    "sci-fi/page/%d/" to "Sci-Fi",
                    "seinen/page/%d/" to "Seinen",
                    "shoujo/page/%d/" to "Shoujo",
                    "shounen/page/%d/" to "Shounen",
                    "slice-of-life/page/%d/" to "Slice of Life",
                    "space/page/%d/" to "Space",
                    "sports/page/%d/" to "Sports",
                    "super-power/page/%d/" to "Super Power",
                    "supernatural/page/%d/" to "Supernatural",
            )
